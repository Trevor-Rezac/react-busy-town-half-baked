...
function App() {
  ...
  return (
    <div className="App">
      ...
      */}
      <VehicleList trafficArr={trafficArr}/>
      <div className='buttons'>
        {/* This part is weird */}
        ...
        <button onClick={() => setTrafficArr([...trafficArr, 'car'])}>Car</button>
        ...
        <button onClick={() => setTrafficArr([...trafficArr, 'bus'])}>Bus</button>
        ...
        <button onClick={() => setTrafficArr([...trafficArr, 'truck'])}>Truck</button>
        ...
        <button onClick={() => setTrafficArr([...trafficArr, 'motorcycle'])}>Motorcycle</button>
      </div>
